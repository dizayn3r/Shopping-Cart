...
import 'package:shopping_cart/models/categorie_model.dart';
import 'package:shopping_cart/models/product_model.dart';
import 'package:shopping_cart/models/trending_productmodel.dart';

List<TrendingProductModel> getTrendingProducts() {
  List<TrendingProductModel> trendingProducts = [];
  TrendingProductModel productModel = TrendingProductModel();
  //1
